const jsonUrl = 'https://raw.githubusercontent.com/Benedictkawagga/JSON/refs/heads/main/data.json';
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: counts,
                    backgroundColor: ['#4CAFF9', '#FF9729', '#2196F3', '#FFC107', '#9C27B0'],
                }]
            },
            options: {
                responsive: true,
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: counts,
                    backgroundColor: ['#4CA799', '#FF5722', '#2196H9', '#FFC107', '#9C27B0', '#4DD950', '#FF9622', '#2196F3', '#FFC107', '#9C27B0', '#9FAF50', '#F09722', '#3096F3', '#FFC107', '#9C27B0', '#ff4590', '#0f1124'],
                }]
            },
            options: {
                responsive: true,
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: counts,
                    backgroundColor: ['#4DD950', '#FF9622', '#2196F3', '#FFC107', '#9C27B0', '#9FAF50', '#F09722', '#3096F3', '#FFC107', '#9C27B0', '#ff4590', '#0f1124'],
                }]
            },
            options: {
                responsive: true,
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: counts,
                    backgroundColor: ['#9FAF50', '#F09722', '#3096F3', '#FFC107', '#9C27B0', '#ff4590', '#0f1124'],
                }]
            },
            options: {
                responsive: true,
